...
public class Shooter {
    ...
    private RelativeEncoder topEnco,  bottomEnco;
    ...
    public Shooter(int bottomPort, int topPort ){
        ...
        topEnco = topMotor.getEncoder();
        bottomEnco = bottomMotor.getEncoder();
    ...
    public void shoot(double velocity){
        ...
        topPID.setReference(velocity, ControlType.kVelocity);
